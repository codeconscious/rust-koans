...
// You can concat (append) a &str to a String.
#[test]
...
fn slicing_the_string() {
    let string = "Boom";
    assert!(&string[0..2] == "Bo"); //- `..` is exclusive at the end
}

// However these are BYTE offsets not character offsets - //- Important!
// rust will panic if you try and slice within a character boundary //- Important!
#[test]
#[should_panic]
fn slicing_the_byte() {
    let dog = "忠犬ハチ公";
    let _slice = &dog[0..4]; //- Was 2
}
